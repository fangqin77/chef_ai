...
CREATE TABLE `favorites`  (
  ...
  UNIQUE INDEX `uk_fav`(`post_id` ASC, `user_id` ASC) USING BTREE,
  ...
  CONSTRAINT `fk_fav_user` FOREIGN KEY (`user_id`) REFERENCES `userss` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
