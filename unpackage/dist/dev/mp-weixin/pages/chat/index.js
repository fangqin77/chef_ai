  ...
  methods: {
    ...
    sendMessage: function sendMessage() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var query, aiMessageIndex, _response$data, response, content, parsedData;
              ...
              case 11:
                ...
                try {
                  if (typeof content === 'string') {
                    ...
                    if (parsedData && (0, _typeof2.default)(parsedData) === 'object' && parsedData.name) {
                      content = _this2.formatRecipeData(parsedData);
                    }
                  } else if (content && (0, _typeof2.default)(content) === 'object' && content.name) {
                    content = _this2.formatRecipeData(content);
                  }
                } catch (error) {
                  // 如果不是JSON格式，保持原样
                }
    ...
    // 格式化菜谱数据
    formatRecipeData: function formatRecipeData(recipe) {
      var formatted = '';

      // 1. 菜名标题（单独一行）
      if (recipe.name) {
        formatted += "\uD83C\uDF7D\uFE0F **".concat(recipe.name, "**\n\n");
      }

      // 2. 基本信息部分
      var hasBasicInfo = false;
      ...
      if (recipe.typeId) {
        ...
        basicInfoContent += "\u2022 \u5206\u7C7B: ".concat(typeMap[recipe.typeId] || '其他', "\n");
        hasBasicInfo = true;
      }
      if (recipe.ingredients) {
        basicInfoContent += "\u2022 \u98DF\u6750\u6570\u91CF: ".concat(recipe.ingredients, "\u79CD\n");
        hasBasicInfo = true;
      }
      if (recipe.condiments) {
        basicInfoContent += "\u2022 \u8C03\u5473\u6599: ".concat(recipe.condiments, "\n");
        hasBasicInfo = true;
      }
      if (hasBasicInfo) {
        formatted += "\uD83D\uDCCB **\u57FA\u672C\u4FE1\u606F**\n".concat(basicInfoContent, "\n");
      }
      ...
      if (recipe.method) {
        ...
        var methodContent = '';
        methodLines.forEach(function (line, index) {
          methodContent += "".concat(index + 1, ". ").concat(line.trim(), "\n");
        });
        formatted += "".concat(methodContent, "\n");
      }
      ...
      if (recipe.nutrition) {
        ...
        if (recipe.nutrition.calories) {
          nutritionContent += "\u2022 \u70ED\u91CF: ".concat(recipe.nutrition.calories, "\n");
          hasNutrition = true;
        }
        if (recipe.nutrition.protein) {
          nutritionContent += "\u2022 \u86CB\u767D\u8D28: ".concat(recipe.nutrition.protein, "\n");
          hasNutrition = true;
        }
        if (recipe.nutrition.fat) {
          nutritionContent += "\u2022 \u8102\u80AA: ".concat(recipe.nutrition.fat, "\n");
          hasNutrition = true;
        }
        if (recipe.nutrition.carbohydrates) {
          nutritionContent += "\u2022 \u78B3\u6C34\u5316\u5408\u7269: ".concat(recipe.nutrition.carbohydrates, "\n");
          hasNutrition = true;
        }
        if (hasNutrition) {
          formatted += "\uD83D\uDCCA **\u8425\u517B\u6210\u5206**\n".concat(nutritionContent, "\n");
        }
      }

      // 5. 食用建议部分
      if (recipe.suggestion) {
        formatted += "\uD83D\uDCA1 **\u98DF\u7528\u5EFA\u8BAE**\n".concat(recipe.suggestion, "\n\n");
      }
