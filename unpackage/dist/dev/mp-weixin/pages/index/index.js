...
var _default = {
  ...
  methods: {
    ...
    // 检查登录状态并显示登录选项
    checkLoginAndAutoAuth: function checkLoginAndAutoAuth() {
      var _this2 = this;
      var token = uni.getStorageSync('token');
      ...
      if (token) {
        ...
        setTimeout(function () {
          ...
          _this2.showLoginChoice();
        }, 1000); // 增加延迟时间到1秒
      }
    },
    // 显示登录选择弹窗
    showLoginChoice: function showLoginChoice() {
      var _this3 = this;
    ...
    // 触发微信授权登录
    triggerWechatLogin: function triggerWechatLogin() {
      var _this4 = this;
      ...
      // 监听登录成功事件
      this.$once('loginSuccess', function () {
        console.log('登录成功，开始调用接口');
        _this4.loadRecommendations();
      });
    },
    // 加载推荐菜谱
    loadRecommendations: function loadRecommendations() {
      ...
      getRandomRecipes(5).then(function (res) {
        ...
        _this5.recommendedRecipes = list.map(function (r) {
          return {
        ...
        console.log('菜谱接口调用成功，推荐列表:', _this5.recommendedRecipes.length);
      }).catch(function (err) {
