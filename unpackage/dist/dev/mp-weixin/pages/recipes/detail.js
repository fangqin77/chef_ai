...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/recipes/detail.vue */ 61));
// @ts-ignore
...
/* harmony import */ var _detail_vue_vue_type_template_id_198c1434___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=198c1434& */ 62);
...
var render = function () {
  ...
  var l0 = _vm.formatMethod(_vm.recipe.method)
    ...
    loadRecipeDetail: function loadRecipeDetail(id) {
      ...
      (0, _recipes.getRecipeDetail)(id).then(function (res) {
        if (res) {
          ...
          console.log('菜谱详情数据:', _this.recipe); // 调试日志
        }
      }).catch(function (err) {
