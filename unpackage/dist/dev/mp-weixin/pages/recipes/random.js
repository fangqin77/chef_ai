...
var _default = {
  ...
  methods: (0, _defineProperty2.default)({
    loadRandomRecipes: function loadRandomRecipes() {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return (0, _recipes.getRandomRecipes)(3);
              case 4:
                res = _context.sent;
                _this.randomRecipes = Array.isArray(res) ? res.map(function (r) {
                  return {
                    id: r.id,
                    name: r.name || '菜谱',
                    ...
                    steps: r.method ? r.method.split('↵').filter(function (step) {
                      return step.trim();
                    }).map(function (step) {
                      return step.trim();
                    }) : ['暂无做法信息'],
              ...
              case 8:
                ...
                console.error('加载随机菜谱失败:', _context.t0);
                uni.showToast({
                  title: '加载失败',
                  icon: 'none'
                });
    ...
    selectRecipe: function selectRecipe(index) {
      this.selectedIndex = index;
    },
    prevRecipe: function prevRecipe() {
    ...
    nextRecipe: function nextRecipe() {
      if (this.randomRecipes.length === 0) return;
      this.selectedIndex = (this.selectedIndex + 1) % this.randomRecipes.length;
    }
  }, "selectRecipe", function selectRecipe(index) {
    var recipeId = this.randomRecipes[index].id;
    uni.navigateTo({
      url: "/pages/recipes/detail?id=".concat(recipeId)
    });
  })
};
...
var _random = _interopRequireDefault(__webpack_require__(/*! ./pages/recipes/random.vue */ 97));
// @ts-ignore
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _random_vue_vue_type_template_id_5e3557a6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./random.vue?vue&type=template&id=5e3557a6& */ 98);
/* harmony import */ var _random_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./random.vue?vue&type=script&lang=js& */ 100);
...
/* harmony import */ var _random_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./random.vue?vue&type=style&index=0&lang=css& */ 102);
...
var render = function () {
  ...
  var l0 = _vm.selectedRecipe
    ? _vm.__map(_vm.selectedRecipe.steps, function (step, index) {
        var $orig = _vm.__get_orig(step)
        var g0 = step.replace(/^\d+\.\s*/, "").trim()
        var g1 = step.endsWith("。")
        return {
          $orig: $orig,
          g0: g0,
          g1: g1,
