  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var token, headers, dateParam, requestConfig, _yield$uni$request, _yield$uni$request2, err, response;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 29:
                _this3.items = response.data.data.map(function (item) {
                  return {
                    id: item.id,
                    name: item.name,
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return uni.request({
                  url: "/api/recipes/".concat(it.id, "/remove-from-daily"),
                  method: 'DELETE',
                  data: {
                    date: it.plannedDate
                  }
