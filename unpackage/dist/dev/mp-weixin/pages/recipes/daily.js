...
var _daily = _interopRequireDefault(__webpack_require__(/*! ./pages/recipes/daily.vue */ 82));
// @ts-ignore
...
/* harmony import */ var _daily_vue_vue_type_template_id_0ded1d06___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./daily.vue?vue&type=template&id=0ded1d06& */ 83);
/* harmony import */ var _daily_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./daily.vue?vue&type=script&lang=js& */ 85);
...
/* harmony import */ var _daily_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./daily.vue?vue&type=style&index=0&lang=css& */ 87);
  ...
  methods: {
    loadData: function loadData() {
      ...
      var items = (ids || []).map(function (id) {
        ...
        return {
          id: id,
          name: _this.safeDecode(fromCard.name || fromRecent.name || ''),
      ...
      items.forEach(function (it, idx) {
        ...
        var idx0 = _this.findIndexById(it.id);
        if (idx0 >= 0) _this.items[idx0]._gIndex = idx0;
        map[d].push(_this.items[idx0]);
      });
    ...
    remove: function remove(it) {
      ...
      var ids = (uni.getStorageSync('favorites_recipes') || []).map(function (x) {
        return String(x);
      });
      ...
      // 兼容旧的收藏时间元数据（若存在则清理）
      var meta = uni.getStorageSync('favorites_meta') || {};
      if (meta[key]) {
        delete meta[key];
    ...
    onTouchEnd: function onTouchEnd(e, idx) {
      ...
      if (distance < 8) {
        ...
        Promise.resolve().then(function () {
          return _this2.handleTap ? _this2.handleTap(it) : _this2.onRowTap(it);
        });
        return;
      }
      var dx = it._dx || 0;
    ...
    goDetail: function goDetail(it) {
      ...
      var encodedId = rawId ? encodeURIComponent(rawId) : '';
