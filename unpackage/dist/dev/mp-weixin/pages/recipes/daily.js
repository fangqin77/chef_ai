...
var render = function () {
  ...
  var l0 = _vm.__map(_vm.items, function (it, idx) {
    var $orig = _vm.__get_orig(it)
    var m0 = _vm.formatTime(it.favTs)
    return {
      $orig: $orig,
      m0: m0,
    }
  ...
  methods: {
    loadData: function loadData() {
      ...
      var items = (ids || []).map(function (id) {
        ...
        var favTs = meta && meta[key] ? meta[key] : 0;
        return {
          id: id,
    ...
    remove: function remove(it) {
      ...
      var idx = ids.indexOf(String(it.id));
      if (idx >= 0) {
        ids.splice(idx, 1);
    ...
    onTouchMove: function onTouchMove(e, idx) {
      ...
      // 仅允许向左滑动显示删除
      var clamped = Math.max(-160, Math.min(0, dx));
    ...
    goDetail: function goDetail(it) {
      // 跳转详情（仅传递 id，详情页自行回填）
      uni.navigateTo({
        url: "/pages/recipes/detail?id=".concat(it.id)
      });
    },
...
var _daily = _interopRequireDefault(__webpack_require__(/*! ./pages/recipes/daily.vue */ 98));
// @ts-ignore
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _daily_vue_vue_type_template_id_0ded1d06___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./daily.vue?vue&type=template&id=0ded1d06& */ 99);
/* harmony import */ var _daily_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./daily.vue?vue&type=script&lang=js& */ 101);
...
/* harmony import */ var _daily_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./daily.vue?vue&type=style&index=0&lang=css& */ 103);
