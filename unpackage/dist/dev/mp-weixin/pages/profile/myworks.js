...
var _myworks = _interopRequireDefault(__webpack_require__(/*! ./pages/profile/myworks.vue */ 117));
// @ts-ignore
...
/* harmony import */ var _myworks_vue_vue_type_template_id_39b610f2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./myworks.vue?vue&type=template&id=39b610f2& */ 118);
/* harmony import */ var _myworks_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./myworks.vue?vue&type=script&lang=js& */ 120);
...
/* harmony import */ var _myworks_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./myworks.vue?vue&type=style&index=0&lang=css& */ 124);
...
var _objectWithoutProperties2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/objectWithoutProperties */ 122));
  ...
  methods: {
    loadPosts: function loadPosts() {
      ...
      try {
        ...
        var arr = Array.isArray(local) ? local : [];
        // 预设编辑态属性，保证响应式
        arr.forEach(function (p) {
          ...
          _this.$set(p, '_editing', false);
          _this.$set(p, '_editForm', {
            name: p.name || '',
            text: p.text || ''
          });
        });
    ...
    deletePost: function deletePost(p) {
      ...
      uni.showModal({
        ...
        success: function success(res) {
          if (res.confirm) {
            var next = _this2.posts.filter(function (item) {
