            ...
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                if (response && response.code === 200 && response.data) {
                  // 成功获取后端数据
                  backendHistory = _this.formatBackendHistory(response.data); // 合并本地历史
    ...
    formatBackendHistory: function formatBackendHistory(historyData) {
      ...
      return historyData.map(function (item) {
        return {
          ...
          time: _this2.formatTime(item.createTime || item.timestamp || item.time)
        };
      });
    },
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.prev = 2;
                _context2.next = 5;
                return _this3.$api.getPostByCommentId(it.postId);
              case 5:
                        ...
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            ...
                            case 12:
                              ...
                              console.error('清空浏览历史失败:', _context3.t0);
